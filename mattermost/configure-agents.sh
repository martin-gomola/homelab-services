...
AGENTS_CODEX_PROVIDER="${AGENTS_CODEX_PROVIDER:-openai}"
AGENTS_CODEX_API_URL="${AGENTS_CODEX_API_URL:-https://api.openai.com/v1}"
...
AGENTS_ALLOWED_UPSTREAM_HOSTNAMES="${AGENTS_ALLOWED_UPSTREAM_HOSTNAMES:-host.docker.internal,api.openai.com}"
